    ...
    <>
      ...
      <Container>
        ...
        <div className="prose mx-auto mt-12">
          ...
          <Heading h={4}>3-1-1．利用目的について</Heading>
          <p>
          ...
          <Heading h={4}>3-1-2．保存期間について</Heading>
          ...
          <Heading h={4}>3-1-3．当サイトがコメントに対してできることについて</Heading>
          <p>
          ...
          <Heading h={4}>3-2-1．利用目的について</Heading>
          <p>
          ...
          <Heading h={4}>3-2-2．保存期間について</Heading>
          <p>お問い合わせフォームに入力された個人情報は、3年間保存します。</p>
          <Heading h={4}>3-2-3．個人情報取得の同意について</Heading>
          <p>
          ...
          <Heading h={4}>3-3-1．利用目的について</Heading>
          ...
          <Heading h={4}>3-3-2．保存期間について</Heading>
          <p>当サイトに残されたコメントの Cookie は、1年間保存されます。</p>
          <Heading h={4}>3-3-3．第三者によるCookie情報の取得について</Heading>
          <p>
